...
def main() -> None:
    ...
    network.stream_network.mean = network.stream_network.mean.to(device=device)
    network.stream_network.std = network.stream_network.std.to(device=device)
